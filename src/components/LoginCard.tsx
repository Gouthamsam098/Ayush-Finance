      ...
      >
        ...
        <div className="relative z-10">
          <div className="mb-6 flex flex-col items-center text-center">
            {/* The official logo as one lockup — mark, divider and wordmark
                together, exactly as supplied. Previously this was a cropped
                icon beside separate text, which did not match the brand. */}
            <motion.div
              initial={{ opacity: 0, scale: 0.94, y: -6 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1], delay: 0.1 }}
            >
              <BrandLogo tone="onDark" className="h-[52px]" />
            </motion.div>
