...
const variants: Record<Variant, string> = {
  primary: 'bg-gradient-to-b from-primary-400 to-primary text-white shadow-[0_1px_0_rgba(255,255,255,.15)_inset,0_4px_12px_-2px_rgba(79,70,229,.45)] hover:shadow-[0_1px_0_rgba(255,255,255,.15)_inset,0_6px_20px_-2px_rgba(79,70,229,.55)] hover:brightness-105',
