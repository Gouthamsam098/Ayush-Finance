  ...
  return (
    <div className="relative flex h-screen w-screen overflow-hidden" style={{ background: '#2e0196' }}>
      ...
      <div className="relative z-10 flex h-full w-full flex-col overflow-y-auto md:flex-row md:overflow-hidden">
        ...
        <div className="relative z-40 flex h-full w-full items-center justify-center overflow-hidden p-5 sm:p-8 md:w-[42%] md:p-10">
          <div
            className="pla-noise pointer-events-none absolute inset-0"
            style={{
              backgroundImage:
